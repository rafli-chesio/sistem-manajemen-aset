    ...
    <AuthenticatedLayout>
        ...
        <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mt-8 lg:mt-0">
            <div class="relative w-full max-w-md">
                ...
                <input type="text" class="w-full pl-10 pr-4 py-2.5 bg-white border-none rounded-2xl text-sm focus:ring-2 focus:ring-indigo-100 shadow-[0_2px_10px_rgba(0,0,0,0.02)] text-slate-600 placeholder-slate-400" placeholder="Search...">
            </div>
        ...
        <template #right>
            <div class="p-6 flex flex-col h-full gap-8">
                ...
                <div class="flex flex-col items-center mt-2">
                    ...
                    <p class="text-xs font-medium text-slate-400 mt-0.5 uppercase tracking-wider">{{ roles[0]?.replace('_', ' ') || 'User' }}</p>
                ...
                <!-- Timeline / Reminders -->
                <div class="flex-1">
                    <h4 class="font-bold text-slate-800 text-sm mb-4">{{ isSuperAdmin ? 'Aktivitas Terkini' : 'Reminders' }}</h4>
                    
                    <!-- Super Admin: Audit Logs Timeline -->
                    <div v-if="isSuperAdmin" class="relative pl-4 border-l-2 border-slate-100 space-y-6">
